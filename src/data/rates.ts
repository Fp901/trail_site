...
export const rates: RateCard[] = [
  {
    ...
    note: 'Flat rate for exclusive use by up to 12 guests. Includes all conservation levies.',
  },
  {
    id: 'international',
    label: 'Foreign Nationals',
    total: TOTAL_INTERNATIONAL, // R72,000
    note: 'A 20% premium on the resident rate to cover additional conservation levies. Exclusive use by up to 12 guests. Includes all conservation levies. The Foreign National premium is pro-rated for groups comprising a mix of Foreign Nationals and Residents.',
  },
];
