...
export const logisticsBlocks: LogBlock[] = [
  {
    id: 'catering',
    kicker: 'Dining',
    title: 'All-inclusive, generous bush hospitality',
    body: [
      ...
      'Because you walk 15 to 20 km the next morning in Big 5 terrain, heavy spirits are excluded apart from gin for sundowners, and wine and beer are served as a curated daily selection. Any other drinks can be bought at the lodges; guests may not bring their own.',
    ],
  },
  {
    id: 'lodges',
